            ...
            parallel {
                stage("ssh") {
                    ...
                    steps {
                        sh '''
                #!/bin/bash
                curl -X DELETE 'http://admin:113ea566fc33a1@18.204.211.163:8080//credentials/store/system/domain/_/credential/ab347119-9e7a-4336-904d-42a6f7713750/delete' --data-urlencode 'json={
                  "": "0",
                  "credentials": {
                    "scope": "GLOBAL",
                    "id": "'"$id"'",
